...
class CourseSection(models.Model):
    ...
    inst_email = models.ForeignKey('Instructor', models.DO_NOTHING, db_column='inst_email')
    stud_email = models.ForeignKey('Student', models.DO_NOTHING, db_column='stud_email')
